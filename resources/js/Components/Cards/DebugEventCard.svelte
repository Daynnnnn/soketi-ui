...
<div on:click={() => selectedEventMessage = debug_event.data} class="cursor-pointer w-full relative rounded-lg border border-gray-300 py-5 shadow-sm flex items-center space-x-3 transition duration-200 hover:bg-gray-50 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
